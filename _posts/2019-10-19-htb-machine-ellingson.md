...
<p>
      <ul>
        ...
        <li>Follow up my first <a href="{{ '_posts/reverse-engineering/2019-09-28-buffer-overflow-practical-case-study.md' | relative_url }}">buffer overflow</a> presentation with a second one covering ROP and more advanced topics.</li>
      </ul>
</p>
